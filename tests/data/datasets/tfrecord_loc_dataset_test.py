...
from fex.data import TFRecordLocalDataset
...
class TestTFRecordLocalDataset(TestCase):
    ...
    def test_dataset(self):
        ...
        batch_size = 32
        my_dataset = TFRecordLocalDataset(data_path, shuffle=True, input_fn=input_fn)
        sampler = torch.utils.data.RandomSampler(range(len(my_dataset)))
