...
class Attention(nn.Module):
    ...
    Reference:
        ...
        Zhou et al. "Refiner: Refining Self-attention for Vision
            Transformers" - https://arxiv.org/abs/2106.03714
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            verbose: if True, logger.info is activated
            name: model name
    ...
    def _make_stage(
        ...
        if stride != 1 or self.inplanes != dim:
            if stride != 1 and use_avgdown:
                ...
                proj = nn.Conv2d(self.inplanes, dim,
                                 kernel_size=1, stride=stride)
...
@register_model
def resnet_v67(pretrained=False, **kwargs):
    model_name = 'resnet_v67'
