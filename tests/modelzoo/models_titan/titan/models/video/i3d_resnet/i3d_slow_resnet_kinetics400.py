...
__all__ = ['i3d_slow_resnet50_f32s2',
           'i3d_slow_resnet50_f16s4', 
           'i3d_slow_resnet50_f8s8',
           'i3d_slow_resnet101_f32s2', 
           'i3d_slow_resnet101_f16s4',
           'i3d_slow_resnet101_f8s8']
...
@register_model
def i3d_slow_resnet50_f32s2(pretrained=False, **kwargs):
    model_name = 'i3d_slow_resnet50_f32s2'
    pretrained_config, model_config = get_configs(**kwargs)
    model = ResNet_SlowFast(depth=50, name=model_name, **model_config)
    if pretrained:
...
@register_model
def i3d_slow_resnet50_f16s4(pretrained=False, **kwargs):
    model_name = 'i3d_slow_resnet50_f16s4'
    pretrained_config, model_config = get_configs(**kwargs)
    model = ResNet_SlowFast(depth=50, name=model_name, **model_config)
    if pretrained:
        weight_path = download_weights(
...
@register_model
def i3d_slow_resnet50_f8s8(pretrained=False, **kwargs):
    model_name = 'i3d_slow_resnet50_f8s8'
    pretrained_config, model_config = get_configs(**kwargs)
    model = ResNet_SlowFast(depth=50, name=model_name, **model_config)
    if pretrained:
        weight_path = download_weights(
...
@register_model
def i3d_slow_resnet101_f32s2(pretrained=False, **kwargs):
    model_name = 'i3d_slow_resnet101_f32s2'
    pretrained_config, model_config = get_configs(**kwargs)
    model = ResNet_SlowFast(depth=101, name=model_name, **model_config)
    if pretrained:
        weight_path = download_weights(
            model_name,
            **pretrained_config)
...
@register_model
def i3d_slow_resnet101_f16s4(pretrained=False, **kwargs):
    model_name = 'i3d_slow_resnet101_f16s4'
    pretrained_config, model_config = get_configs(**kwargs)
    model = ResNet_SlowFast(depth=101, name=model_name, **model_config)
    if pretrained:
        weight_path = download_weights(
...
@register_model
def i3d_slow_resnet101_f8s8(pretrained=False, **kwargs):
    model_name = 'i3d_slow_resnet101_f8s8'
    pretrained_config, model_config = get_configs(**kwargs)
    model = ResNet_SlowFast(depth=101, name=model_name, **model_config)
    if pretrained:
        weight_path = download_weights(
