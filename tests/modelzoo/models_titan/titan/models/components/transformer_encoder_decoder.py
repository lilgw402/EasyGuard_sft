...
from titan.models.components.layernorm import LayerNormTypes
...
TransformerDecoderLayerOutput = namedtuple('TransformerDecoderLayerOutput',
                                           ['hidden_states', 'self_attn_weights', 'cross_attn_weights', 'present_key_value', 'attn_bias', 'encoder_attn_bias'])
...
TransformerDecoderOutput = namedtuple('TransformerDecoderOutput',
                                      ['last_hidden_state', 'all_hidden_states', 'all_self_attns', 'all_cross_attns', 'all_key_values'])

Seq2SeqModelOutput = namedtuple('Seq2SeqModelOutput',
                                ['last_hidden_state', 'past_key_values', 'decoder_hidden_states', 'decoder_attentions', 'cross_attentions',
