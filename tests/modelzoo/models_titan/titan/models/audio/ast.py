...
class ASTModel(nn.Module):
    """
    The AST model.
    :param pretrained: load pretrained weights or not
    ...
    def __init__(
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            audio_model = ASTModel(pretrained=False, label_dim=527, fstride=10, tstride=10, input_fdim=128, input_tdim=1024, model_size='base384', verbose=True)
...
@register_model
def ast_model(pretrained=False, **kwargs):
    ...
    model = ASTModel(pretrained=False, **kwargs)
    ...
    if pretrained:
        ...
        model = ASTModel(pretrained=pretrained, weight_path=weight_path, **kwargs)
