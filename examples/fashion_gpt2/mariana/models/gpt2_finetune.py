...
class GPT2LMModelwClassificationHeadRMPAD(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.classification_head = nn.Linear(self.config.n_embed, self.config.num_labels, bias=self.config.classification_head_bias)
    ...
    def forward(
        ...
        if classification_labels is not None:
            ...
            classification_loss = self.loss_fct_classification(classification_logits, classification_labels.long().view(-1))
