...
if __name__ == '__main__':
    # pretrain = 'hdfs://haruna/home/byte_ecom_govern/user/wangxian/projects/fashionaudio/fashoin_sv/version_13299379/checkpoints/epoch=3-step=2188.ckpt'
    # pretrain = './sv_2188.ckpt'
    pretrain = None
    model = load_model(pretrain=pretrain)
    load_pretrained_model_weights(
        model,
        # 'hdfs://haruna/home/byte_ecom_govern/user/wangxian/projects/fashionaudio/fashoin_sv/version_13299379/checkpoints/epoch=3-step=2188.ckpt',
        './sv_2188.ckpt',
