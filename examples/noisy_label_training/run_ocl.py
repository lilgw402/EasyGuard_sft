...
class MyModel(CruiseModule):
    ...
    def setup(self, stage) -> None:
        ...
        self.criterion_1 = OnlineConfidentLearning(alpha=0.5, n_classes=self.config_optim.class_num_lv1, smoothing=self.config_optim.label_smooth_1)
        self.criterion_2 = OnlineConfidentLearning(alpha=0.5, n_classes=self.config_optim.class_num_lv2, smoothing=self.config_optim.label_smooth_2)
    ...
    def training_step(self, batch, idx):
        ...
        train_loss_dict = {'loss': train_loss, "cls_loss1": cls_loss_lv1, "cls_loss2": cls_loss_lv2, 
                            "train_acc1": acc1, "train_acc_2": acc2}
    ...
    def validation_epoch_end(self, outputs: List[Dict[str, torch.Tensor]]) -> None:
        ...
        val_metric_dict = {'macro_f1_lv1': macro_f1_lv1, 'macro_f1_lv2': macro_f1_lv2,
                           'val_acc1': accuracy_lv1, 'val_acc2': accuracy_lv2}
