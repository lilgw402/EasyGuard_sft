...
class EcomLiveGandalfAutoDisNNAsrAitmCruiseModel(MtlGandalfCruiseModule):
    ...
    def _create_loss(self, censor_output, reject_output, censor_label, reject_label, constraint_weight=0.3, loss_weight=None):
        ...
        label_constraint = torch.maximum(self._post_process_output(reject_output) - self._post_process_output(censor_output),
