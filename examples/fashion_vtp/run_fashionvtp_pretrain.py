...
class MMClsModel(CruiseModule):
    ...
    def training_step(self, batch, idx):
        ...
        t_output = self.text_visual_and_fuse_model.encode_text(input_ids=input_ids, input_segment_ids=input_segment_ids, input_mask=input_mask)
        ...
        with torch.no_grad():
            ...
            t_output_m = self.text_visual_and_fuse_model.encode_text_m(input_ids=input_ids, input_segment_ids=input_segment_ids, input_mask=input_mask)
    ...
    def configure_optimizers(self):
        ...
        if self.config_optim.optimizer == "sgd":
            ...
            optimizer = torch.optim.AdamW(optimizer_grouped_parameters, eps=self.config_optim.optimizer_eps, betas=(0.9, 0.999),
                                lr=self.config_optim.base_lr, weight_decay=self.config_optim.weight_decay)
