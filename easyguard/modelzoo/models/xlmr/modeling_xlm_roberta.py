...
class XLMRobertaForCausalLM(RobertaForCausalLM, ModelBase):
    """
...
class XLMRobertaForMaskedLM(RobertaForMaskedLM, ModelBase):
    """
...
class XLMRobertaForMultipleChoice(RobertaForMultipleChoice, ModelBase):
    """
...
class XLMRobertaForQuestionAnswering(RobertaForQuestionAnswering, ModelBase):
    """
