...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "alibaba-pai/textcnn-en": "https://atp-modelzoo-sh.oss-cn-shanghai.aliyuncs.com/release/easynlp_modelzoo/alibaba-pai/textcnn-en/vocab.txt",
    }
}

PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "alibaba-pai/textcnn-en": 512,
}

PRETRAINED_INIT_CONFIGURATION = {
    "alibaba-pai/textcnn-en": {"do_lower_case": True},
}
...
class TextCNNTokenizer(BertTokenizer):
    r"""
