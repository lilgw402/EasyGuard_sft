...
class DisentangledSelfAttention(nn.Module):
    ...
    def forward(
        ...
        # print ('attention_scores: ', torch.max(attention_scores).cpu().detach().numpy(),
        # torch.min(attention_scores).cpu().detach().numpy() )
        ...
        # print ('attention_scores_2: ', torch.max(attention_scores).cpu().detach().numpy(),
        # torch.min(attention_scores).cpu().detach().numpy() )
