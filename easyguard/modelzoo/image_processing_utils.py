...
class ImageProcessingMixin(PushToHubMixin):
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        output_image_processor_file = os.path.join(
            save_directory, IMAGE_PROCESSOR_NAME
        )
    ...
    def get_image_processor_dict(
        ...
        if os.path.isfile(pretrained_model_name_or_path):
            ...
            resolved_image_processor_file = download_url(
        ...
        try:
            ...
            with open(
                resolved_image_processor_file, "r", encoding="utf-8"
            ) as reader:
                text = reader.read()
