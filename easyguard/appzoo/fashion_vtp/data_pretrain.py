...
class PretrainDataModule(CruiseDataModule):
    ...
    def setup(self):
        ...
        self.params = {'ocr_max_len': self.hparams.ocr_max_len, 
...
class TorchvisionDataset(DistLineReadingDataset):
    ...
    def __init__(self, params, data_path, rank=0, world_size=1, 
                       shuffle=True, repeat=False, is_training=False):
    ...
    def __iter__(self):
        for example in self.generate():
            try:
                ...
                video_path = f'/mnt/bd/video-text-pretrain-frames-{drive_no}/local_frames_part_{file_no}/clip_{clip_id}'
                ...
                # frame_paths = [f'/mnt/bd/video-text-pretrain-frames-{drive_no}/local_frames_part_{file_no}/clip_{clip_id}/{frame_no}.jpg' for frame_no in range(frame_num)][:num]
    ...
    def collect_fn(self, data):
        ...
        res = {"frames": torch.stack(frames, dim=0), 
