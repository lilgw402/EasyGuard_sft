...
class QqqtFinetuneModel(CruiseModule):
    def __init__(self,
                 ...
                 pretrained_path: str = 'hdfs://haruna/home/byte_arnold_lq/data/reckon/mlxlab_aml_test/tasks/3124349/trials/10167660/output/checkpoints/epoch=1-step=612792.ckpt',
                 pretrained_rename_prefix: Dict[str, str] = {'deberta': 'pretrained'},
                 lr: float = 6e-6,
                 wd: float = 0.01,
                 margin: float = 0.3,
                 ):
        super().__init__()
        self.save_hparams()
        self.pretrained = DebertaModel(**self.hparams.bert)
    ...
    def forward(self,
        ...
        bert_output = self.pretrained(
                ...
                sentence_label=True)  # need pooled output
