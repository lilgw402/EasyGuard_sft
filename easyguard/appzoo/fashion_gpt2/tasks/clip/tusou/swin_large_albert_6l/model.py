...
from mariana.data.fex.datamodule.tusou import TusouDataModule
...
class CLIPTusouSwinAlbertTower(CruiseModule):
    """Swin + Albert 双塔"""
    def __init__(self,
...
if __name__ == '__main__':
    ...
    ckpter = ModelCheckpoint(monitor='step',
                             ...
                             enable_trace=False)
    cli = CruiseCLI(
        CLIPTusouSwinAlbertTower,
        datamodule_class=TusouDataModule,
        trainer_defaults={
            'precision': 16,
