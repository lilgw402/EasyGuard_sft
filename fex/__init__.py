...
Date: 2020-11-09 20:33:28
LastEditTime: 2020-11-12 11:20:09
LastEditors: Huang Wenguan
Description: init of fex
'''
import time
import sys
import os
...
try:
    ...
    _logger.warn("[NOTICE] colorlog python package is not installed, will display log in normal mode")
