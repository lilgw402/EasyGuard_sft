...
from fex.nn.backbone.dino import trunc_normal_
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, return_dict=None, mask=None):
        # mim
        ...
        return_dict = self.return_all_tokens if \
            return_dict is None else return_dict
        if return_dict:
